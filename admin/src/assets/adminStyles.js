...
export const adminNavbarStyles = {
  ...
  menuButton:
    "text-white p-2 rounded-md hover:bg-emerald-700 focus:outline-none",
...
export const addItemPageStyles = {
  ...
  imageUploadContainer:
    "border-2 border-dashed rounded-lg p-4 text-center cursor-pointer hover:border-emerald-500 transition",
  ...
  hiddenInput: "hidden",
  submitButton:
    "w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-lg flex items-center justify-center",
};
...
export const listItemsPageStyles = {
  ...
  filterSelect:
    "w-full pl-10 pr-8 py-2.5 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 appearance-none",
  filterSelectArrow:
    "pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700",
  emptyStateContainer: "text-center py-12",
  emptyStateIconContainer:
    "bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16 mx-auto mb-4 flex items-center justify-center",
  ...
  placeholderImage:
    "bg-gray-200 border-2 border-dashed rounded-xl w-10 h-10 mr-3",
...
export const ordersPageStyles = {
  ...
  statsCard: (borderColor) =>
    `bg-white rounded-xl shadow p-6 border-l-4 ${borderColor}`,
  statsCardInner: "flex items-center",
  ...
  actionButtons: "flex space-x-2",
  viewButton:
    "text-sm bg-emerald-100 hover:bg-emerald-200 text-emerald-700 py-1 px-3 rounded-full transition-colors",
  cancelButton: (isDisabled) =>
    `text-sm bg-red-100 hover:bg-red-200 text-red-700 py-1 px-3 rounded-full transition-colors ${
  ...
  modalContainer:
    "bg-white rounded-xl shadow-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto",
  ...
  modalSection: "mb-8",
  modalSectionTitle:
    "text-lg font-bold text-emerald-800 mb-4 flex items-center",
  modalIcon: "mr-2",
  ...
  modalPlaceholderImage:
    "bg-gray-200 border-2 border-dashed rounded-xl w-16 h-16 mr-4",
  modalOrderTotalSection: "p-4 bg-gray-50",
  modalOrderTotalRow: "flex justify-between py-2",
  modalOrderTotalRowLast:
    "flex justify-between pt-4 mt-2 border-t border-gray-200",
  ...
  modalFooterPrimaryButton:
    "px-6 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors",
};
